...
var require_react_is_production_min = __commonJS({
  "node_modules/.pnpm/react-is@17.0.2/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
    ...
    exports.isValidElementType = function(a) {
      return "string" === typeof a || "function" === typeof a || a === d2 || a === f2 || a === v2 || a === e || a === l || a === m || a === w || "object" === typeof a && null !== a && (a.$$typeof === p || a.$$typeof === n2 || a.$$typeof === g || a.$$typeof === h || a.$$typeof === k2 || a.$$typeof === u || a.$$typeof === q || a[0] === r) ? true : false;
    };
    exports.typeOf = y2;
  }
});
...
var require_build = __commonJS({
  "node_modules/.pnpm/pretty-format@27.5.1/node_modules/pretty-format/build/index.js"(exports) {
    ...
    var getPrintFunctionName2 = (options) => options && options.printFunctionName !== void 0 ? options.printFunctionName : DEFAULT_OPTIONS3.printFunctionName;
    var getEscapeRegex2 = (options) => options && options.escapeRegex !== void 0 ? options.escapeRegex : DEFAULT_OPTIONS3.escapeRegex;
    var getEscapeString2 = (options) => options && options.escapeString !== void 0 ? options.escapeString : DEFAULT_OPTIONS3.escapeString;
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-magic-string.3a794426.js
...
// node_modules/.pnpm/@vitest+utils@0.28.3/node_modules/@vitest/utils/dist/helpers.js
...
// node_modules/.pnpm/@vitest+utils@0.28.3/node_modules/@vitest/utils/dist/index.js
...
// node_modules/.pnpm/@vitest+runner@0.28.3/node_modules/@vitest/runner/dist/chunk-tasks.js
...
// node_modules/.pnpm/@vitest+runner@0.28.3/node_modules/@vitest/runner/dist/index.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-utils-global.442d1d33.js
var import_pathe2 = require("pathe");

// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-utils-env.860d90c2.js
var _a;
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/vendor-_commonjsHelpers.addc3445.js
...
// node_modules/.pnpm/@vitest+utils@0.28.3/node_modules/@vitest/utils/dist/diff.js
...
// node_modules/.pnpm/tinyspy@1.0.2/node_modules/tinyspy/dist/index.js
function d(t, e) {
  if (!t)
    throw new Error(e);
}
...
function C(t, e, i) {
  ...
  }, [r, n2] = o(), c = k(t, r), s = Object.getPrototypeOf(t), l = s && k(s, r), a = c || l;
...
// node_modules/.pnpm/@vitest+spy@0.28.3/node_modules/@vitest/spy/dist/index.js
...
// node_modules/.pnpm/@vitest+expect@0.28.3/node_modules/@vitest/expect/dist/index.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-runtime-rpc.9c0386cc.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-utils-import.0402c9db.js
var import_pathe4 = require("pathe");

// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-snapshot-env.6457638e.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-utils-base.904102a8.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-utils-tasks.a9a8d8e1.js
...
function parseSingleStack(raw) {
  ...
  if (file.startsWith("file://"))
    file = file.slice(7);
  file = (0, import_pathe3.resolve)(file);
  return {
    method,
    file,
...
function waitNextTick() {
  ...
  return new Promise((resolve3) => setTimeout2(resolve3, 0));
}
...
function requireReactIs_production_min() {
  ...
  var b = 60103, c = 60106, d2 = 60107, e = 60108, f2 = 60114, g = 60109, h = 60110, k2 = 60112, l = 60113, m = 60120, n2 = 60115, p = 60116, q = 60121, r = 60122, u = 60117, v2 = 60129, w = 60131;
  if ("function" === typeof Symbol && Symbol.for) {
    var x2 = Symbol.for;
    b = x2("react.element");
    c = x2("react.portal");
  ...
  var z = g, A2 = b, B = k2, C2 = d2, D = p, E = n2, F = c, G = f2, H = e, I = l;
...
async function ensureDirectoryExists(filePath) {
  try {
    ...
    await environment.prepareDirectory((0, import_pathe4.join)((0, import_pathe4.dirname)(filePath)));
  } catch (e) {
  }
}
...
var SnapshotState = class {
  ...
  _addSnapshot(key, receivedSerialized, options) {
    ...
    if (options.isInline) {
      ...
      stacks.forEach((i) => i.file = slash2(i.file));
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-integrations-run-once.38756e30.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/chunk-integrations-utils.dae69d89.js
...
// node_modules/.pnpm/vitest@0.28.3/node_modules/vitest/dist/index.js
...
function warn(msg, type2 = "warn") {
  console[type2](`\u26A0\uFE0F  [unplugin-vue-router]: ${msg}`);
}
...
function resolveOptions(options) {
  const root = options.root || DEFAULT_OPTIONS2.root;
  const routesFolder = normalizeRoutesFolderOption(
    options.routesFolder || DEFAULT_OPTIONS2.routesFolder
  ).map((routeOption) => __spreadProps(__spreadValues({}, routeOption), {
    src: (0, import_pathe6.resolve)(root, routeOption.src)
  }));
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, DEFAULT_OPTIONS2), options), {
    routesFolder
  });
}
...
function mockWarn() {
  globalExpect.extend({
    toHaveBeenWarned(received) {
      ...
      const passed = warn2.mock.calls.some(
        (args) => typeof received === "string" ? args[0].indexOf(received) > -1 : received.test(args[0])
      );
      if (passed) {
        return {
          pass: true,
        ...
        const msgs = warn2.mock.calls.map((args) => args[0]).join("\n - ");
        return {
          pass: false,
...
Actual messages:
 ...
 - ${msgs}`
    ...
    toHaveBeenWarnedLast(received) {
      asserted.set(received.toString(), received);
      const lastCall = warn2.mock.calls[warn2.mock.calls.length - 1][0];
      const passed = typeof received === "string" ? lastCall.indexOf(received) > -1 : received.test(lastCall);
      if (passed) {
        return {
          pass: true,
...
Actual messages:
 ...
 - ${msgs}`
    ...
    toHaveBeenWarnedTimes(received, n2) {
      asserted.set(received.toString(), received);
      let found = 0;
      warn2.mock.calls.forEach((args) => {
        const isFound = typeof received === "string" ? args[0].indexOf(received) > -1 : received.test(args[0]);
        if (isFound) {
          found++;
        }
      });
      if (found === n2) {
        return {
          pass: true,
          message: () => `expected "${received}" to have been warned ${n2} times.`
        };
      } else {
        return {
          pass: false,
          message: () => `expected "${received}" to have been warned ${n2} times but got ${found}.`
        };
      }
    }
  });
  let warn2;
  const asserted = /* @__PURE__ */ new Map();
  beforeEach(() => {
    asserted.clear();
    warn2 = vi.spyOn(console, "warn");
    warn2.mockImplementation(() => {
    });
  });
  afterEach(() => {
    const assertedArray = Array.from(asserted);
    const nonAssertedWarnings = warn2.mock.calls.map((args) => args[0]).filter((received) => {
      return !assertedArray.some(([key, assertedMsg]) => {
        return typeof assertedMsg === "string" ? received.indexOf(assertedMsg) > -1 : assertedMsg.test(received);
      });
    });
    warn2.mockRestore();
...
describe("options", () => {
  ...
  it("ensure starting dots in extensions", () => {
    ...
    globalExpect('Invalid extension "vue"').toHaveBeenWarned();
  });
});
/*
 * @version    1.4.0
